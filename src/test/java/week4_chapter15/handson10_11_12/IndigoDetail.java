...
public class IndigoDetail {
	...
	public static WebElement toSelect(WebDriver driver) {
		WebElement toselect = driver
				.findElement(By.xpath("(//ul[@class='ausuggest']//li[@onchange = 'ChangeCabin();'])[5]"));
		return toselect;
	}
	...
	public static WebElement clickAirIndia(WebDriver driver) {
		WebElement airIndia = driver
				.findElement(By.xpath("//label[@class='check-box ng-binding'][normalize-space()='Air India']"));
		return airIndia;
	}

	public static WebElement clickAirIndiaExpress(WebDriver driver) {
		WebElement airIndiaExpress = driver
				.findElement(By.xpath("//label[@class='check-box ng-binding'][normalize-space()='Air India Express']"));
		return airIndiaExpress;
	}

	public static WebElement clickAkasa(WebDriver driver) {
		WebElement akasa = driver
				.findElement(By.xpath("//label[@class='check-box ng-binding'][normalize-space()='AkasaAir']"));
		return akasa;
	}

	public static WebElement clickSpiceJet(WebDriver driver) {
		WebElement indigo = driver
				.findElement(By.xpath("//label[@class='check-box ng-binding'][normalize-space()='SpiceJet']"));
		return indigo;
	}

	public static WebElement clickstop1(WebDriver driver) {
		WebElement clickstop1 = driver
				.findElement(By.xpath("(//div[@class='_stpsecnw']//label[@class='check-box'])[2]"));
		return clickstop1;
	}

	public static WebElement clickstop2(WebDriver driver) {
		WebElement clickstop2 = driver
				.findElement(By.xpath("(//div[@class='_stpsecnw']//label[@class='check-box'])[3]"));
		return clickstop2;
	}
